...
static void
reg_proc_uE(const reg_t *reg, float *lval, const float *rval)
{
	if (lval != NULL) {
...
const reg_t		regfile[] = {
	...
	REG_DEF(pm.lu_gain_TAKE,_u,		"",	"%3f",	REG_READ_ONLY, &reg_proc_uE, NULL),
	REG_DEF(pm.lu_gain_GIVE,_u,		"",	"%3f",	REG_READ_ONLY, &reg_proc_uE, NULL),
