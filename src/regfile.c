...
const reg_t		regfile[] = {
	...
	REG_DEF(pm.hall_minimal_hz,,		"Hz",	"%1f",	REG_CONFIG, NULL, NULL),

	REG_DEF(pm.qenc_base_EP,,		"",	"%i",	REG_READ_ONLY, NULL, NULL),
	REG_DEF(pm.qenc_TIM,,			"",	"%i",	REG_READ_ONLY, NULL, NULL),
	REG_DEF(pm.qenc_relR,,			"",	"%3f",	REG_READ_ONLY, NULL, NULL),
