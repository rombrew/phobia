...
const reg_t		regfile[] = {
	...
	REG_DEF(ap.pull_gain[0],,		"kg",	"%4f",	REG_CONFIG, NULL, NULL),
	REG_DEF(ap.pull_gain[1],,		"",	"%4e",	REG_CONFIG, NULL, NULL),
