...
void adcEnable()
{
	...
	/* Enable analog PA0 PA1 PA2 PA3 pins.
	 * */
	...
	/* Configure ADC2 on PA2.
	 * */
	ADC2->CR1 = 0;
	ADC2->CR2 = ADC_CR2_JEXTEN_0 | ADC_CR2_JEXTSEL_0;
	ADC2->SMPR1 = 0;
	ADC2->SMPR2 = ADC_SMPR2_SMP2_0;
	ADC2->JSQR = ADC_JSQR_JSQ4_1;

	/* Configure ADC3 on PA1.
	 * */
	ADC3->CR1 = 0;
...
void adcDisable()
{
	/* Disable PA0 PA1 PA2 PA3 pins.
	 * */
	MODIFY_REG(GPIOA->MODER, GPIO_MODER_MODER0 | GPIO_MODER_MODER1
			| GPIO_MODER_MODER2 | GPIO_MODER_MODER3, 0);
