...
DPS_mode_DRIVE_EABI()
{
	...
	TIM3->DIER = 0;
	TIM3->CCMR1 = TIM_CCMR1_IC2F_1 | TIM_CCMR1_CC2S_0
		| TIM_CCMR1_IC1F_1 | TIM_CCMR1_CC1S_0;
	TIM3->CCMR2 = 0;
	TIM3->CCER = 0;
	TIM3->CNT = 32767;
	TIM3->PSC = 0;
...
int DPS_get_HALL()
{
	...
	HS  = (IDR & (1U << XGPIO_GET_N(GPIO_HALL_A))) ? LEG_A : 0U;
	HS |= (IDR & (1U << XGPIO_GET_N(GPIO_HALL_B))) ? LEG_B : 0U;
	HS |= (IDR & (1U << XGPIO_GET_N(GPIO_HALL_C))) ? LEG_C : 0U;
